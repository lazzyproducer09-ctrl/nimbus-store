...
export function WishlistHeaderButton() {
  ...
  return (
    ...
    >
      ...
      {hydrated && count > 0 && (
        <span className="absolute -right-1.5 -top-1.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-bad-deep0 px-1 text-[10px] font-semibold text-white">
          {count}
        </span>
      )}
    </Link>
