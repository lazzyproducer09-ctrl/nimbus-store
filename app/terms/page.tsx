...
export const metadata: Metadata = { title: "Terms of Service — NIMBUS" };

export default function TermsPage() {
  return (
    <PolicyPage title="Terms of Service">
      <p>
        Welcome to NIMBUS. By using our website and placing an order, you agree to the
        following terms.
      </p>
      ...
      <p>
        ...
        NIMBUS name, logo and content belong to us and may not be copied without
        permission.
      </p>

      <h2>Limitation of liability</h2>
      <p>
        To the extent permitted by law, NIMBUS is not liable for indirect or
      ...
      <h2>Contact</h2>
      <p>
        Questions? Email <a href="mailto:support@nimbus.store">support@nimbus.store</a>.
      </p>
    </PolicyPage>
  );
}
